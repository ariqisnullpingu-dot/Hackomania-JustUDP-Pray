        ...
        >
          ...
          `,
            ...
            <div className="absolute top-6 left-6 z-20">
                <button
                    onClick={() => router.push("/")}
                    className="flex items-center gap-2 rounded-xl bg-gray-900/80 border border-gray-700/50 text-gray-400 hover:text-white transition-all shadow-xl group"
            ...
            <div
                className={`relative z-10 flex flex-col gap-6 items-center max-w-xl w-full transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
                <div className="flex flex-col gap-6 text-center items-center mb-12">
                    <h1
                        className="text-5xl sm:text-7xl font-black text-center leading-[1] tracking-tight mb-4 text-green-200"
                    >
                        How will you
                        <br />
                        <span 
                            style={{
                                background: "linear-gradient(135deg, #8EF28E 0%, #44ED44 50%, #19C619 100%)",
                    ...
                    <p
                        ...
                        style={{ color: "rgba(138,252,116,0.55)" }}
                    >
                        Donation Choice
                    </p>
